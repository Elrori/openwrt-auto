...
if [ ! -d "openwrt" ]; then
  git clone -b $CONFIG_TAGS https://github.com/openwrt/openwrt.git
else
  echo "Pass"
fi
cd openwrt
...
# Add EBAZ4205 patches
echo "-----------> Add EBAZ4205 patches"
mkdir -p target/linux/zynq/$PATCHES
cp ../../patches/ebaz4205-v5.10-u-boot-2019.07/020-v5.10-ebaz4205-support.patch target/linux/zynq/$PATCHES
cp ../../patches/ebaz4205-v5.10-u-boot-2019.07/111-u-boot-2019.07-ebaz4205-support.patch package/boot/uboot-zynq/patches
git apply ../../patches/ebaz4205-v5.10-u-boot-2019.07/openwrt-ebaz4205.patch
